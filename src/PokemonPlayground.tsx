...
export default function PokemonPlayground() {
              ...
              <Card
                ...
                heading={
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    <Tooltip content={`ID na Pokédex: #${poke.id}`}>
                ...
                actions={
                  <div style={{ display: 'flex', gap: '0.5rem', width: '100%', flexDirection: 'column' }}>
                    <Button variant="solid" size="md" roundness="round" fullWidth onClick={() => handleCapture(formattedName)}>
                      Capturar
                    </Button>
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      <Button variant="outline" size="sm" fullWidth onClick={() => handleDetails(formattedName)}>
                        Detalhes
                      </Button>
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1rem' }}>
                  <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                    {poke.types.map((t) => {
                      ...
                      return (
                        ...
                        >
                          <span style={{ display: 'inline-flex' }}>
                            <Badge color={color} shape="pilled">
                              {typeName}
                            </Badge>
                          </span>
                        </Tooltip>
                  ...
                  <div style={{ marginTop: '0.5rem' }}>
                    <Tooltip content={`Experiência base ao derrotar um ${formattedName} selvagem`}>
